...
using SubscriberDead.Models;

namespace SubscriberDead
{
    /// <summary>
    /// https://test-subscriber-dead.azurewebsites.net/api/subscriberDead?code=D_QsVzwg3JHa1ZkCGxwSLkBkpFEA_5AuzrbV-GOpG2QtAzFutRLOfQ=="
    /// </summary>
    public static class SubscriberDead
    {
        [FunctionName("subscriberDead")]
